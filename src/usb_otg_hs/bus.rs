...
use crate::usb_otg_hs::fifo_const::*;
use crate::usb_otg_hs::{regs, state, Config, EndpointData, PhyType, BUS_WAKER_PWR};
use crate::usb_otg_hs::global_states::{BUS_WAKER_PWR, state};
