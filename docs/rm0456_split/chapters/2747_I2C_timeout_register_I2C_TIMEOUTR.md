...
LPUART clocks
The simplified block diagram given in Section 67.4.1: LPUART block diagram shows two
...
When the dual clock domain feature is not supported, the lpuart_ker_ck is the same
...
M1: bit 28) in the LPUART_CR1 register (see Figure 810).
•
