...
Figure 529. Update rate examples depending on mode and TIMx_RCR register settings
...
external clock (external clock mode 2, see Section 54.3.7)

•

trigger for the slave mode (see Section 54.3.30)

•

PWM reset input for cycle-by-cycle current regulation (see Section 54.3.9)

Figure 530 below describes the tim_etr_in input conditioning. The input polarity is defined
