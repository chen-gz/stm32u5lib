...
A tamper detection can optionally erase the backup registers, backup SRAM, SRAM2,
caches, and cryptographic peripherals. The device resources protected by tamper are
named “device secrets”.
...
TAMP implementation
STM32U575/585 rev. X devices do not implement the active tamper prescaler extension.
This feature is implemented in all other STM32U575/585 revisions, and in the other
