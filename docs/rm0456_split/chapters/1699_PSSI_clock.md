...
Table 422. PSSI input/output pins
PSSI signal
name
...
Input/output Data enable signal

PSSI_RDY

DCMI_VSYNC

Input/output Ready signal
...
Table 423 shows the PSSI internal input/output signals.
Table 423. PSSI internal input/output signals
