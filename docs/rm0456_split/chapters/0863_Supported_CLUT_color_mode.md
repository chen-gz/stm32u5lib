...
Program the CLUT address into DMA2D_FGCMAR (foreground CLUT) or
DMA2D_BGCMAR (background CLUT).

b)

Program the CLUT size with CS[7:0] field in DMA2D_FGPFCCR (foreground
CLUT), or DMA2D_BGPFCCR (background CLUT).

c)

Set START in DMA2D_FGPFCCR (foreground CLUT) or DMA2D_BGPFCCR
...
Table 175. Supported CLUT color mode
CCM
...
Table 176. CLUT data order in memory
CLUT Color mode
