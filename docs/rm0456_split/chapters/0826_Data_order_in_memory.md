...
Table 159. Supported color mode in input (continued)
CM[3:0]
...
If the original format is direct color mode (ARGB/RGB), the extension to 8 bits per channel is
...
Table 160. Data order in memory
Color Mode
