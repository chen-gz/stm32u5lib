...
FMAC functional description

26.3.1

General description
The FMAC is shown in Figure 108.
Figure 108. Block diagram
...
A more detailed description of the filter operations is given in Section 26.3.6: Filter functions.
