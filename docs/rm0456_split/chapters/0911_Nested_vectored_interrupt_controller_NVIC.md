...
Up to 140 maskable interrupt channels (not including the 16 Cortex-M33
with FPU interrupt lines)
...
The NVIC and the processor core interface are closely coupled, enabling low-latency
...
Example: SysTick clock source is CPU clock HCLK of 100 MHz, to match a time base
of 1 ms:
