...
Table 417. Data storage in RGB progressive video format
Byte address
...
Table 418. Data storage in YCbCr progressive video format
Byte address
...
each pixel, encoded in 8 bits, is stored as shown in Table 419.
The result is a monochrome image having the same resolution as the original YCbCr data.
Table 419. Data storage in YCbCr progressive video format - Y extraction mode
Byte address
