...
in Section 49.4.4: AES procedure to perform a cipher operation on page 1929 to manage
...
DATATYPE[1:0] field of the AES_CR register (see Section 49.4.14: AES data registers and
...
Figure 466 gives an example of suspend/resume operation: Message 1 is suspended in
...
the way explained in Section 49.4.6: AES ciphertext stealing and data padding.
...
the way explained in Section 49.4.6: AES ciphertext stealing and data padding.
For more information on data swapping, refer to Section 49.4.14: AES data registers and
data swapping.
...
encryption with other KMOD[1:0] values, refer to Section 49.4.13.
...
Figure 471. Then clear the CCF flag by setting the CCF bit of the AES_ICR register.
...
in Section 49.4.4). Select normal key mode by setting KMOD[1:0] to 00. For decryption with
other KMOD[1:0] values, refer to Section 49.4.13.
...
Follow the steps described in Section 49.4.5: AES decryption round key preparation, in
...
Figure 472. Then clear the CCF flag by setting the CCF bit of the AES_ICR register.
