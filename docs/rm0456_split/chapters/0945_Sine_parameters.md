...
Table 198. Cosine parameters (continued)
Parameter
...
ARG1.
The secondary argument is the modulus m. If m is greater than 1, a scaling must be applied
in software to adapt it to the q1.31 range of ARG2.
