...
Table 160. Data order in memory (continued)
L4
...
in DMA2D_FGPFCCR/DMA2D_BGPFCCR registers as shown in the table below.
...
replaced by the original alpha value multiplied by the ALPHA[7:0] value of
DMA2D_FGPFCCR/DMA2D_BGPFCCR divided by 255.
Table 161. Alpha mode configuration
...
DMA2D_FGPFCCR/DMA2D_BGPFCCR registers. This applies also to the Alpha value
stored in the DMA2D_FGPFCCR/DMA2D_BGPFCCR and in the CLUT.
The R and B fields can also be swapped setting RBS in
