...
The least-significant byte (bits 7:0) correspond to the first byte transferred, and the mostsignificant byte (bits 31:28) corresponds to the forth byte transferred. Table 424 illustrates
the positioning of the data bytes in two 32-bit words.
Table 424. Positioning of captured data bytes in 32-bit words (8-bit width)
