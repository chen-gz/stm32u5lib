...
overwrite mode, the boundary conditions described in Rx FIFO overwrite mode have to
be considered.

Note:

When an accepted message is written to one of the two Rx FIFOs, the unmodified received
