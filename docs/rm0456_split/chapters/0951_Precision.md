...
required, it must be calculated by software and programmed into the SCALE field of the
...
(sine, cosine, phase, modulus), see Figure 105.
...
Figure 106). The square root function converges at roughly twice the speed of the
hyperbolic functions (see Figure 107).
Figure 105. CORDIC convergence for trigonometric functions
...
Figure 106. CORDIC convergence for hyperbolic functions
