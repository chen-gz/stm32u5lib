...
Dual-memory configuration, where 8 bits can be sent/received simultaneously
by accessing two quad or two octal memories in parallel
...
HSPI implementation
Table 263. Instances on STM32U5 series devices
Devices
...
HSPI (JDES251C) standard compliant
