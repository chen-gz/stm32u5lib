...
Introduction
The HSPI supports most external serial memories such as serial PSRAMs, serial NAND and
serial NOR flash memories, HyperRAM™ and HyperFlash™ memories, with the following
functional modes:
•

indirect mode: all the operations are performed using the HSPI registers to preset
