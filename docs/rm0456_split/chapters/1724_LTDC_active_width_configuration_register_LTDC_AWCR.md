...
Refer to Figure 408 and Section 43.4 for an example of configuration.
31
...
These bits defines the accumulated horizontal back porch width that includes the horizontal
...
(VSYNC height + VBP + active height - 1). Refer to Figure 408 and Section 43.4 for an
